...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DonationApp.Core.Entities.BankAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DonationApp.Core.Entities.CampaignLike", b =>
                {
                    b.Property<int>("CampaignId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DonationApp.Core.Entities.SubscribeCampaign", b =>
                {
                    b.Property<int>("CampaignId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DonationApp.Core.Entities.CampaignAccount", b =>
                {
                    b.HasBaseType("DonationApp.Core.Entities.BankAccount");
                    ...
                    b.HasDiscriminator().HasValue("CampaignAccount");
                });
            ...
            modelBuilder.Entity("DonationApp.Core.Entities.ApplicationUser", b =>
                {
                    b.HasOne("DonationApp.Core.Entities.Campaign", null)
            ...
            modelBuilder.Entity("DonationApp.Core.Entities.Campaign", b =>
                {
                    b.HasOne("DonationApp.Core.Entities.ApplicationUser", "Organization")
                        .WithMany()
            ...
            modelBuilder.Entity("DonationApp.Core.Entities.CampaignLikeCount", b =>
                {
                    b.HasOne("DonationApp.Core.Entities.Campaign", "Campaign")
                        .WithOne("CampaignLikeCount")
                        .HasForeignKey("DonationApp.Core.Entities.CampaignLikeCount", "CampaignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DonationApp.Core.Entities.Transaction", b =>
                {
                    b.HasOne("DonationApp.Core.Entities.BankAccount", "BankAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DonationApp.Core.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DonationApp.Core.Entities.CampaignAccount", b =>
                {
                    b.HasOne("DonationApp.Core.Entities.Campaign", "Campaign")
                        .WithOne("CampaignAccount")
                        .HasForeignKey("DonationApp.Core.Entities.CampaignAccount", "CampaignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("DonationApp.Core.Entities.Campaign", b =>
                {
                    b.Navigation("CampaignAccount")
                        .IsRequired();

                    b.Navigation("CampaignLikeCount")
                        .IsRequired();
